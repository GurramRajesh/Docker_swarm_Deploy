...
<div class="row ">
	...
	<h4 style="text-align: center;">Create & Assign Fixed Task</h4>
	<hr>
	<form class="form-horizontal" method="POST" action="fixed_task_inserted_data.php">
		<!--Input Form-->
		...
		<!--Input Form-->
		<div>
			<input type="hidden" name="project" id="project" value="fixed" class="form-control">
		</div>

		<!--Input Form-->
		<div>
			<input type="hidden" name="start_date" id="start_date" class="form-control" placeholder="Start Date" value="2">
		</div>

		<!--Input Form-->
		<div>
			<input type="hidden" name="end_date" id="end_date" class="form-control" placeholder="End Date" value="2">
		</div>
		
		<!--Input Form-->
		<div>
		<input type="hidden" name="phase" id="phase" value="fixed" class="form-control">
...
<div class="row">
	...
	<hr>
		<table class="table table-bordered" id="datatables">
			...
			<tbody>
			<?php
				$sqlAssigntask = "SELECT * FROM `create_task` JOIN assign_task ON create_task.project_id=assign_task.project_id WHERE create_task.project_id='fixed'";
